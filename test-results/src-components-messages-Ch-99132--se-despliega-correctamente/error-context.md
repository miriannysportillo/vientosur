...
- Name: ChatWindow - Usabilidad móvil >> Menú de adjuntos se despliega correctamente
- Location: /workspaces/vientosur/src/components/messages/ChatWindow.e2e.spec.ts:32:3
