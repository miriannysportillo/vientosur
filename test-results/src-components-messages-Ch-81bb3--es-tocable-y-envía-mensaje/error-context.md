...
- Name: ChatWindow - Usabilidad móvil >> Botón de enviar es tocable y envía mensaje
- Location: /workspaces/vientosur/src/components/messages/ChatWindow.e2e.spec.ts:23:3
