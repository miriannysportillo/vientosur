...
- Name: ChatWindow - Usabilidad móvil >> El input de mensaje es visible y usable
- Location: /workspaces/vientosur/src/components/messages/ChatWindow.e2e.spec.ts:16:3
